...
# option 다양하게 결과치 comparison
# parameter 바꿀 땐 op4=1 and 2 both
...
# Simulation 5: Simulation 1 + theta reference에 있는 숫자로 1.5
...
# Real data: stroke & 심혈관질환 - cch에만 있는 변수 <- 모두 측정 변수 modeling
# Handling required
